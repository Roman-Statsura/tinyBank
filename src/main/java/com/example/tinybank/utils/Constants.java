...
public class Constants {
    ...
    public static final String ACCOUNT_PAYMENT_PAGE = "account-payment";
    public static final String ACCOUNT_UPDATE_PAGE = "/account-update";
    public static final String ACCOUNT_CREATE_PAGE = "/account-create";
}
